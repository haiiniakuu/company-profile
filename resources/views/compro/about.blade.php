        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <pre class="fs-5" style="text-align: justify; font-family:'Times New Roman', Times, serif; white-space:pre-wrap; "
                    >      {{ ucfirst($about->description) }}</pre>
                    ...
                    <a class="btn btn-primary py-3 px-5 mt-2" href="{{ route('aboutadmin.index') }}">Read More</a>
                </div>
            </div>
        </div>
    </div>
